...
KONV_OPCIJE = ["apsolutno konvergira", "uvjetno konvergira", "divergira"]
KONV_INT_OPCIJE = ["konvergira", "divergira"]
...
ZADACI = [
    ...
    },
    {
        ...
        "tip": "multi",
        "tocan_odgovor": multi([{"label": "Red je:", "answer": "divergira", "options": KONV_OPCIJE}]),
    ...
    },
    {
        ...
        "hints": [r"Parcijalna integracija: $u=\ln(x+2)$, $\mathrm{d}v=(x+3)\,\mathrm{d}x$.", r"$\mathrm{d}u=\frac{\mathrm{d}x}{x+2}$, a $v=\frac{x^2+6x+8}{2}$ se dijeli s $(x+2)$."]
    },
    {
        "tekst": r"Ispitajte konvergenciju reda $\displaystyle\sum_{n=1}^{\infty} (-1)^n \left(\frac{n-1}{n+1}\right)^{n(n+1)}$.",
        "tip": "multi",
        "tocan_odgovor": multi([{"label": "Red je:", "answer": "apsolutno konvergira", "options": KONV_OPCIJE}]),
    ...
    },
    {
        ...
        "tip": "multi",
        "tocan_odgovor": multi([{"label": "Integral je:", "answer": "divergira", "options": KONV_INT_OPCIJE}]),
        "rjesenje": r"divergira",
    ...
    },
    {
        ...
        "tip": "multi",
        "tocan_odgovor": multi([{"label": "Red je:", "answer": "uvjetno konvergira", "options": KONV_OPCIJE}]),
    ...
    },
    {
        ...
        "hints": [r"Podijeli brojnik s nazivnikom: kvocijent $2$, ostatak $x-3$.", r"$\frac{x-3}{x^2+2x+2}$: rastavi na derivaciju nazivnika i dopuni na puni kvadrat."]
    },
    {
    ...
    },
    {
        ...
        "tip": "multi",
        "tocan_odgovor": multi([{"label": "Integral je:", "answer": "konvergira", "options": KONV_INT_OPCIJE}]),
    ...
    },
    {
        ...
        "hints": [r"Podijeli brojnik s nazivnikom: kvocijent $2$, ostatak $x+1$.", r"$\frac{x+1}{x^2-x+1}$: rastavi na derivaciju nazivnika i dopuni na puni kvadrat."]
    },
    {
    ...
    {
        "tekst": r"Ispitajte (bez računanja) je li funkcija $f(x)=x^2+2x$ integrabilna na $[-2,2]$.",
        "tip": "auto",
        "tocan_odgovor": "integrabilna",
        "rjesenje": r"integrabilna",
        "hints": [r"Polinom je neprekidna funkcija na svakom zatvorenom intervalu."]
    },
    {
